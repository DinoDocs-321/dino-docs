  ...
  return (
    <Container className="my-5">
      ...
      <p className="text-center mb-5">
        Our team consists of six dedicated students, each bringing their unique skills to develop this system. Under the supervision of Dr. Janusz Getta Supervisor, we worked together to deliver a seamless and efficient solution.
      </p>
      <Row>
